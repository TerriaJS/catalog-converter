...
const fs = require("fs");
const root = require("./drought-map/root");
...
function buildCatalog() {
  ...
  fs.writeFileSync("wwwroot/init/drought-map.json", JSON.stringify(processed));
  fs.writeFileSync(
    "wwwroot/init/drought-map_big.json",
...
if (require.main === module) {
  ...
  buildCatalog();
  console.log(
    'Catalog file "wwwroot/init/drought-map.json" (and _big.json) updated'
  );
}
